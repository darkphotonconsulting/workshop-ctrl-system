...
class DynamicSchemas(object):
    ...
    def __init__(self,
        ...
        #self.error = False
        self.system_memory_stats = self.__class__.system_memory_stats 
        self.system_net_stats = self.__class__.system_net_stats
        self.system_cpu_stats = self.__class__.system_cpu_stats
...
class StaticSchemas(object):
    ...
    def __init__(self,
        ...
        self.gpios = self.__class__.gpios 
        self.relays = self.__class__.relays
